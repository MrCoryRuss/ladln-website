...
const content = {
    en: {
          tagline: "Supporting students in Mulegé, Baja California Sur, Mexico since 1976",
          subtitle:
    ...
    es: {
          tagline: "Apoyando a estudiantes en Mulegé, Baja California Sur, México desde 1976",
          subtitle:
        ...
        <section className="relative overflow-hidden bg-white">
                      ...
                      <div className="flex flex-col md:flex-row items-center gap-10 md:gap-16">
                                ...
                                <div className="text-center md:text-left">
                                            ...
                                            <h1 className="text-4xl md:text-5xl font-extrabold leading-tight mb-4" style={{ color: "#333333" }}>
                                                          Los Amigos de <span style={{ color: "#F46A6A" }}>los Niños</span>span>
                                                          <br />
                                                          <span style={{ color: "#253E80" }}>Mulegé</span>span>
                                            </h1>h1>
                                            <p className="text-lg mb-8 leading-relaxed max-w-2xl" style={{ color: "#555555" }}>
                                              {t.subtitle}
                                            </p>p>
              ...
              <div className="text-white" style={{ backgroundColor: "#253E80" }}>
                      ...
                      <div key={s.label} className="flex flex-col">
                                    ...
                                    <span className="text-sm font-medium mt-0.5" style={{ color: "rgba(255,255,255,0.8)" }}>
                                      {s.label}
                                    </span>span>
                      </div>div>
                    ))}
