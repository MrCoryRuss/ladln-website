...
const board: Member[] = [
    {
            ...
            image: "/board/CoryRussell-Headshot.jfif",
    },
    {
            name: "Tracy Russell",
            roleEn: "Secretary",
            ...
            image: "/board/TracyRussell-Headshot.jfif",
    },
    {
            name: "Terri Wolfe",
            roleEn: "Treasurer",
            ...
            image: "/board/terri-Wolfe-professional_headshot.png",
    },
    {
            name: "John Rovers",
    ...
    },
    {
            ...
            bioEn: "",
            bioEs: "",
            image: "/board/sally_headshot.png",
    },
    {
            name: "KJ",
            roleEn: "",
            ...
            bioEn: "",
            bioEs: "",
            image: "/board/kj_professional-headshot.png",
    },
    ];
                                                                           ...
                                                                           { key: m.name, className: "bg-white border border-stone-200 rounded-3xl overflow-hidden shadow-sm" },
                                                                                         ...
                                                                                         h(
                                                                                             ...
                                                                                             { className: "p-6 space-y-3" },
                                                                                                             ...
                                                                                                             role ? h("div", { className: "text-sm font-semibold text-terracotta uppercase tracking-wider" }, role) : null,
                                                                                                             bio ? h("p", { className: "text-stone-600 leading-relaxed text-sm" }, bio) : null,
                                                                                                           ),
                                                                                       );
                                              }),
                                            ),
